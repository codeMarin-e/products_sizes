...
return [
     ...
     */
    'install_behavior' => env('MARINAR_PRODUCT_SIZES_INSTALL_BEHAVIOR', env('MARINAR_INSTALL_BEHAVIOR', true)),
     ...
     * 2 - keep everything
     */
    'delete_behavior' => env('MARINAR_PRODUCT_SIZES_DELETE_BEHAVIOR', env('MARINAR_DELETE_BEHAVIOR', false)),
     ...
     */
    'addons' => [
        // @HOOK_PRODUCT_SIZES_CONFIGS_ADDONS
    ],
    // @HOOK_PRODUCT_SIZES_CONFIGS
];
